...
int main(int argc, char *argv[])
{
	...
	std::string confFile = "/home/an683/ns3-datacenter/simulator/ns-3.39/examples/PowerTCP/config-workload.txt";
	std::string cdfFileName = "/home/an683/ns3-datacenter/simulator/ns-3.39/examples/PowerTCP/websearch.txt";
